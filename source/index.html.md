...
These tools provide the source code they've used to access Tablo devices using the information above (or more?!?!). They provide examples for many things you may want to do.
...
These tools are closed source. The best hope of emulating things they do/allow is to use something like [Wireshark](https://www.wireshark.org/) to capture their network activity and reverse-engineer it.
